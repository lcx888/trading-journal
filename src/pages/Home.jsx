...
const Home = ({ onStart, onDocs }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c]">
      ...
      {/* 文档和帮助入口 */}
      <section className="py-16 px-6 bg-[#0d0d10]">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <button
              onClick={onDocs}
              className="text-left p-6 bg-[#111114] rounded-xl border border-[#1a1a1f] hover:border-[#c9a227]/40 transition-all group"
            >
              <div className="w-12 h-12 rounded-lg bg-[#1a1a1f] flex items-center justify-center mb-4 group-hover:bg-[#c9a227]/10 transition-colors">
                <BookOutlined className="text-2xl text-[#c9a227]" />
              </div>
              <h3 className="text-lg font-semibold text-[#fff] mb-2">使用文档</h3>
              <p className="text-sm text-[#666]">详细的功能说明和操作指南，帮助您快速上手</p>
            </button>
            ...
            >
              <div className="w-12 h-12 rounded-lg bg-[#1a1a1f] flex items-center justify-center mb-4 group-hover:bg-[#c9a227]/10 transition-colors">
                <QuestionCircleOutlined className="text-2xl text-[#c9a227]" />
              </div>
              <h3 className="text-lg font-semibold text-[#fff] mb-2">常见问题</h3>
              <p className="text-sm text-[#666]">关于产品功能、数据导入、AI 分析等常见问题解答</p>
            </button>
          </div>
        </div>
      </section>
